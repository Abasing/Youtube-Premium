...
(function (ExtensionsKeys) {
    ...
    ExtensionsKeys["ShouldCheckUpdatePageConfig"] = "shouldCheckUpdatePageConfig";
    ExtensionsKeys["LastRulesFetchAt"] = "lastRulesFetchAt";
    ExtensionsKeys["UpdatePagePending"] = "updatePagePending";
    ExtensionsKeys["AdLeakBucket"] = "adLeakBucket";
    ExtensionsKeys["AdLeakLastShownAt"] = "adLeakLastShownAt";
    ExtensionsKeys["AdLeakDismissedAt"] = "adLeakDismissedAt";
    ExtensionsKeys["AdLeakStateCache"] = "adLeakStateCache";
    ExtensionsKeys["AdLeakShownCount"] = "adLeakShownCount";
    ExtensionsKeys["AdLeakDetectedSentAt"] = "adLeakDetectedSentAt";
...
(function (SettingsKeys) {
    ...
    SettingsKeys["AdLeakNotices"] = "adLeakNotices";
    SettingsKeys["AdLeakNoticeConfig"] = "adLeakNoticeConfig";
    SettingsKeys["RulesVersion"] = "rulesVersion";
    ...
    SettingsKeys["OldShowUpdatePageNextLaunch"] = "showUpdatePageNextLaunch";
    SettingsKeys["OldAnnotations"] = "annotations";
    SettingsKeys["SyncServerRules"] = "syncServerRules";
    SettingsKeys["DisablePausePopup"] = "disablePausePopup";
    SettingsKeys["LoopControlsEnabled"] = "loopControlsEnabled";
    SettingsKeys["RydEnabled"] = "rydEnabled";
    SettingsKeys["VideoTagsEnabled"] = "videoTagsEnabled";
    SettingsKeys["VolumeBoostEnabled"] = "volumeBoostEnabled";
...
(function (ActionsEnum) {
    ...
    ActionsEnum["GetSettings"] = "GET_SETTINGS";
    ActionsEnum["SetSetting"] = "SET_SETTING";
    ActionsEnum["CanShowAdLeakNotice"] = "CAN_SHOW_AD_LEAK_NOTICE";
    ActionsEnum["AdLeakEvent"] = "AD_LEAK_EVENT";
    ActionsEnum["GetVoteData"] = "GET_VOTE_DATA";
...
;// ./src/constants/default-data/ad-leak-notice.ts
var DefaultAdLeakNoticeConfig = {
    detector: {
        minVisibleMs: 3000,
        consecutiveVideos: 2,
    },
    frequency: {
        episodeQuietHours: 24,
        dismissDays: 7,
    },
    ctaUrl: '#',
    texts: {
        attribution: 'YouTube Premium · An ad got through',
        body: "YouTube changed how it delivers ads, and extensions can only react after each change.",
        primaryCta: 'Turn off ads',
        secondaryCta: 'Report this ad',
        optOut: 'Turn off these notices',
        thanks: 'Thanks, that helps us fix it faster.',
    },
};
...
var Settings = (settings_a = {},
    ...
    settings_a[SettingsKeys.AdLeakNotices] = true,
    settings_a[SettingsKeys.AdLeakNoticeConfig] = DefaultAdLeakNoticeConfig,
    settings_a[SettingsKeys.RulesVersion] = null,
    settings_a[SettingsKeys.SyncServerRules] = false,
    settings_a[SettingsKeys.DisablePausePopup] = true,
    settings_a[SettingsKeys.LoopControlsEnabled] = true,
    settings_a[SettingsKeys.RydEnabled] = true,
    settings_a[SettingsKeys.VideoTagsEnabled] = true,
    settings_a[SettingsKeys.VolumeBoostEnabled] = true,
    settings_a);
...
var SESSION_IS_STARTUP_KEY = 'isStartup';
var isStartup = false;
var startupHandler = function () {
    chrome.runtime.onStartup.addListener(function () { return startup_handler_awaiter(void 0, void 0, void 0, function () {
        var e_1;
        var _a;
        return startup_handler_generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    isStartup = true;
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4, chrome.storage.session.set((_a = {}, _a[SESSION_IS_STARTUP_KEY] = true, _a))];
                case 2:
                    _b.sent();
                    return [3, 4];
                case 3:
                    e_1 = _b.sent();
                    console.error('persist startup flag failed:', e_1);
                    return [3, 4];
                case 4: return [2];
            }
        });
...
var clearStartupSessionFlag = function () { return startup_handler_awaiter(void 0, void 0, void 0, function () {
    var e_2;
    return startup_handler_generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4, chrome.storage.session.remove(SESSION_IS_STARTUP_KEY)];
            case 1:
                _a.sent();
                return [3, 3];
            case 2:
                e_2 = _a.sent();
                console.error('clear startup flag failed:', e_2);
                return [3, 3];
            case 3: return [2];
        }
    });
}); };
var consumeStartupWake = function () { return startup_handler_awaiter(void 0, void 0, void 0, function () {
    var result, e_3;
    return startup_handler_generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!isStartup) return [3, 2];
                isStartup = false;
                return [4, clearStartupSessionFlag()];
            case 1:
                _a.sent();
                return [2, true];
            case 2:
                _a.trys.push([2, 5, , 6]);
                return [4, chrome.storage.session.get(SESSION_IS_STARTUP_KEY)];
            case 3:
                result = _a.sent();
                if (!result[SESSION_IS_STARTUP_KEY]) {
                    return [2, false];
                }
                return [4, clearStartupSessionFlag()];
            case 4:
            ...
            case 5:
                e_3 = _a.sent();
                console.error('read startup flag failed:', e_3);
                return [2, false];
            case 6: return [2];
        }
    });
...
var createTab = function (url) { return Promise.resolve(); };
            ...
            switch (_d.label) {
                case 0:
                    ...
                    return [4, setMultipleToChromeStorage((_c = {},
                            ...
                            _c[SettingsKeys.AdLeakNotices] = true,
                            _c))];
                case 1:
                    _d.sent();
...
var MIN_USER_LIVE_FOR_POPUP = (/* unused pure expression or super */ null && (1000 * 60 * 60 * 24 * 3));
var GENERAL_POPUPS_RESTRICTION_TIME = (/* unused pure expression or super */ null && (1000 * 60 * 60 * 24));
var ANTI_ADBLOCK_POPUP_RESTRICTION_TIME = (/* unused pure expression or super */ null && (1000 * 60 * 60 * 24));

;// ./src/helpers/dev-log.ts
var dev_log_read = (undefined && undefined.__read) || function (o, n) {
    var m = typeof Symbol === "function" && o[Symbol.iterator];
    if (!m) return o;
    var i = m.call(o), r, ar = [], e;
    try {
...
var dev_log_spreadArray = (undefined && undefined.__spreadArray) || function (to, from, pack) {
    if (pack || arguments.length === 2) for (var i = 0, l = from.length, ar; i < l; i++) {
        if (ar || !(i in from)) {
            if (!ar) ar = Array.prototype.slice.call(from, 0, i);
            ar[i] = from[i];
...
;// ./src/types/ad-leak-event.type.ts
var AdLeakEventName;
(function (AdLeakEventName) {
    AdLeakEventName["Detected"] = "adLeakDetected";
    AdLeakEventName["NoticeShown"] = "adLeakNoticeShown";
    AdLeakEventName["NoticeDismiss"] = "adLeakNoticeDismiss";
    AdLeakEventName["NoticeOptout"] = "adLeakNoticeOptout";
    AdLeakEventName["NoticeReportClick"] = "adLeakNoticeReportClick";
})(AdLeakEventName || (AdLeakEventName = {}));

;// ./src/types/storage.type.ts


;// ./src/types/popup-config.type.ts
...
;// ./src/background/helpers/ad-leak-events.ts
var ad_leak_events_assign = (undefined && undefined.__assign) || function () {
    ad_leak_events_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return ad_leak_events_assign.apply(this, arguments);
};
var ad_leak_events_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
var ad_leak_events_generator = (undefined && undefined.__generator) || function (thisArg, body) {
    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g = Object.create((typeof Iterator === "function" ? Iterator : Object).prototype);
    return g.next = verb(0), g["throw"] = verb(1), g["return"] = verb(2), typeof Symbol === "function" && (g[Symbol.iterator] = function() { return this; }), g;
    function verb(n) { return function (v) { return step([n, v]); }; }
    function step(op) {
...
var EVENTS_URL = "".concat("https://api.adblock-for-youtube.com", "/api/v2/tr/al");
var DETECTED_QUIET_MS = 24 * HOUR_IN_MS;
var SEND_ATTEMPTS = 3;
var SEND_RETRY_DELAY_MS = 1500;
var wait = function (ms) { return new Promise(function (resolve) { return setTimeout(resolve, ms); }); };
var chain = Promise.resolve();
var serialize = function (task) {
    var run = chain.then(task, task);
    chain = run.catch(function () { return undefined; });
    return run;
};
var post = function (payload) { return false; };
var buildPayload = function (input) { return ad_leak_events_awaiter(void 0, void 0, void 0, function () {
    var shown, rulesVersion, payload;
    return ad_leak_events_generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, getFromChromeStorage(ExtensionsKeys.AdLeakShownCount).catch(function () { return undefined; })];
            case 1:
                shown = _a.sent();
                rulesVersion = Settings[SettingsKeys.RulesVersion];
                payload = ad_leak_events_assign(ad_leak_events_assign({}, input), { exposureCount: typeof shown === 'number' && Number.isInteger(shown) && shown >= 0 ? shown : 0 });
...
var claimDetectedSlot = function () {
    return serialize(function () { return ad_leak_events_awaiter(void 0, void 0, void 0, function () {
        var sentAt;
        return ad_leak_events_generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, getFromChromeStorage(ExtensionsKeys.AdLeakDetectedSentAt).catch(function () { return undefined; })];
                case 1:
                    sentAt = _a.sent();
                    if (Number.isFinite(sentAt) && Date.now() - sentAt < DETECTED_QUIET_MS) {
                        return [2, false];
                    }
                    return [4, setToChromeStorage(ExtensionsKeys.AdLeakDetectedSentAt, Date.now()).catch(function () { return undefined; })];
                case 2:
                    _a.sent();
                    return [2, true];
            }
...
var sendAdLeakEvent = function (input) { return ad_leak_events_awaiter(void 0, void 0, void 0, function () {
    var _a, payload;
    return ad_leak_events_generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = input.event === AdLeakEventName.Detected;
                if (!_a) return [3, 2];
                return [4, claimDetectedSlot()];
            case 1:
                _a = !(_b.sent());
                _b.label = 2;
            case 2:
                ...
                return [4, buildPayload(input)];
            case 3:
                payload = _b.sent();
                devLog('[ad-leak] event', payload);
                return [4, post(payload)];
            case 4:
                _b.sent();
                return [2];
        }
...
;// ./src/background/helpers/adblock360-presence.ts
var adblock360_presence_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
var adblock360_presence_generator = (undefined && undefined.__generator) || function (thisArg, body) {
    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g = Object.create((typeof Iterator === "function" ? Iterator : Object).prototype);
    return g.next = verb(0), g["throw"] = verb(1), g["return"] = verb(2), typeof Symbol === "function" && (g[Symbol.iterator] = function() { return this; }), g;
    function verb(n) { return function (v) { return step([n, v]); }; }
    function step(op) {
...
var isAdBlock360Running = function () { return false; };

;// ./src/background/helpers/ad-leak-gate.ts
var ad_leak_gate_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
var ad_leak_gate_generator = (undefined && undefined.__generator) || function (thisArg, body) {
    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g = Object.create((typeof Iterator === "function" ? Iterator : Object).prototype);
    return g.next = verb(0), g["throw"] = verb(1), g["return"] = verb(2), typeof Symbol === "function" && (g[Symbol.iterator] = function() { return this; }), g;
    function verb(n) { return function (v) { return step([n, v]); }; }
    function step(op) {
...
var STATE_URL = "".concat("https://api.adblock-for-youtube.com", "/api/v2/ad-leak-state");
var STATE_CACHE_MS = 60 * 1000;
var STATE_FALLBACK_MAX_AGE_MS = 24 * HOUR_IN_MS;
var DENIED = { allowed: false };
var parseState = function (payload) {
    var state = payload;
    if (typeof (state === null || state === void 0 ? void 0 : state.enabled) !== 'boolean' || !Number.isFinite(state === null || state === void 0 ? void 0 : state.rolloutPercent)) {
        return null;
    }
    return { enabled: state.enabled, rolloutPercent: Math.min(100, Math.max(0, Number(state.rolloutPercent))) };
};
var isTimestamp = function (value) { return typeof value === 'number' && Number.isFinite(value); };
var getRolloutBucket = function () { return ad_leak_gate_awaiter(void 0, void 0, void 0, function () {
    var existing, bucket;
    return ad_leak_gate_generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, getFromChromeStorage(ExtensionsKeys.AdLeakBucket)];
            case 1:
                existing = _a.sent();
                ...
                return [4, setToChromeStorage(ExtensionsKeys.AdLeakBucket, bucket)];
            case 2:
                _a.sent();
                return [2, bucket];
        }
...
var getLiveState = function () { return { enabled: true, rolloutPercent: 100 }; };
var canShowAdLeakNotice = function () { return ad_leak_gate_awaiter(void 0, void 0, void 0, function () {
    var config, now, stored, dismissedAt, lastShownAt, state, bucket;
    return ad_leak_gate_generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!Settings[SettingsKeys.Ads] || !Settings[SettingsKeys.AdLeakNotices]) {
                    return [2, DENIED];
                }
                config = Settings[SettingsKeys.AdLeakNoticeConfig];
                if (!config.ctaUrl) {
                    return [2, DENIED];
                }
                now = Date.now();
                return [4, getMultipleFromChromeStorage([
                        ExtensionsKeys.AdLeakDismissedAt,
                        ExtensionsKeys.AdLeakLastShownAt,
                    ])];
            case 1:
                stored = _a.sent();
                dismissedAt = stored[ExtensionsKeys.AdLeakDismissedAt];
                if (isTimestamp(dismissedAt) && now - dismissedAt < config.frequency.dismissDays * 24 * HOUR_IN_MS) {
                    return [2, DENIED];
                }
                lastShownAt = stored[ExtensionsKeys.AdLeakLastShownAt];
                if (isTimestamp(lastShownAt) && now - lastShownAt < config.frequency.episodeQuietHours * HOUR_IN_MS) {
                    return [2, DENIED];
                }
                return [4, getLiveState()];
            case 2:
                state = _a.sent();
                if (!(state === null || state === void 0 ? void 0 : state.enabled)) {
                    return [2, DENIED];
                }
                return [4, getRolloutBucket()];
            case 3:
                bucket = _a.sent();
                if (bucket >= state.rolloutPercent) {
                    return [2, DENIED];
                }
                return [4, isAdBlock360Running()];
            case 4:
                if (_a.sent()) {
                    return [2, DENIED];
                }
                return [2, { allowed: true, texts: config.texts, ctaUrl: config.ctaUrl }];
        }
    });
}); };
var rememberAdLeakNoticeShown = function () { return ad_leak_gate_awaiter(void 0, void 0, void 0, function () {
    var shown;
    var _a;
    return ad_leak_gate_generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4, getFromChromeStorage(ExtensionsKeys.AdLeakShownCount)];
            case 1:
                shown = _b.sent();
                return [4, setMultipleToChromeStorage((_a = {},
                        _a[ExtensionsKeys.AdLeakLastShownAt] = Date.now(),
                        _a[ExtensionsKeys.AdLeakShownCount] = (typeof shown === 'number' ? shown : 0) + 1,
                        _a))];
            case 2:
                _b.sent();
                return [2];
...
var rememberAdLeakNoticeDismissed = function () { return ad_leak_gate_awaiter(void 0, void 0, void 0, function () {
    return ad_leak_gate_generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, setToChromeStorage(ExtensionsKeys.AdLeakDismissedAt, Date.now())];
            case 1:
                _a.sent();
                return [2];
        }
...
var handlePageReady = function (sender) {
    var _a;
    var _b;
    ...
    return _a = {},
        ...
        _a.adLeakDetector = Settings[SettingsKeys.AdLeakNoticeConfig].detector,
        _a;
};
var isWatchPageSender = function (sender) {
    var _a, _b, _c;
    try {
        var url = new URL((_c = (_b = (_a = sender.tab) === null || _a === void 0 ? void 0 : _a.url) !== null && _b !== void 0 ? _b : sender.url) !== null && _c !== void 0 ? _c : '');
...
var handleGetSettings = function () {
    var _a;
    return (_a = {},
        _a[SettingsKeys.Ads] = Settings[SettingsKeys.Ads],
        _a[SettingsKeys.InformAboutUpdates] = Settings[SettingsKeys.InformAboutUpdates],
        _a[SettingsKeys.AdLeakNotices] = Settings[SettingsKeys.AdLeakNotices],
        _a[SettingsKeys.DisablePausePopup] = Settings[SettingsKeys.DisablePausePopup],
        _a[SettingsKeys.SyncServerRules] = Settings[SettingsKeys.SyncServerRules],
        _a[SettingsKeys.LoopControlsEnabled] = Settings[SettingsKeys.LoopControlsEnabled],
        _a[SettingsKeys.RydEnabled] = Settings[SettingsKeys.RydEnabled],
        _a[SettingsKeys.VideoTagsEnabled] = Settings[SettingsKeys.VideoTagsEnabled],
        _a[SettingsKeys.VolumeBoostEnabled] = Settings[SettingsKeys.VolumeBoostEnabled],
        _a);
};
var handleSetSetting = function (payload) { return listen_messages_awaiter(void 0, void 0, void 0, function () {
    var isOptOut;
    return listen_messages_generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                isOptOut = payload.key === SettingsKeys.AdLeakNotices && payload.value === false && Settings[payload.key] !== false;
                return [4, setToStorageAndSettings(payload.key, payload.value)];
            case 1:
                _a.sent();
                if (!isOptOut) return [3, 3];
                return [4, sendAdLeakEvent({ event: AdLeakEventName.NoticeOptout })];
            case 2:
                _a.sent();
                _a.label = 3;
            case 3:
                if (payload.key === SettingsKeys.SyncServerRules && payload.value === true) {
                    void updateSettingsFromServer().then(function () {
                        updateDynamicRules();
                    }).catch(function () { return undefined; });
                }
                if (payload.key === SettingsKeys.RydEnabled && payload.value === false) {
                    void removeFromChromeStorage('rydVoteCache').catch(function () { return undefined; });
                }
                return [2, { ok: true }];
        }
    });
}); };
var handleAdLeakEvent = function (input) { return listen_messages_awaiter(void 0, void 0, void 0, function () {
    return listen_messages_generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!(input.event === AdLeakEventName.NoticeShown)) return [3, 2];
                return [4, rememberAdLeakNoticeShown()];
            case 1:
                _a.sent();
                _a.label = 2;
            case 2:
                if (!(input.event === AdLeakEventName.NoticeDismiss)) return [3, 4];
                return [4, rememberAdLeakNoticeDismissed()];
            case 3:
                _a.sent();
                _a.label = 4;
            case 4: return [4, sendAdLeakEvent(input)];
            case 5:
                _a.sent();
                return [2];
        }
...
var handleMessage = function (message, sender) { return listen_messages_awaiter(void 0, void 0, void 0, function () {
    var _a;
    return listen_messages_generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                if (message.type === ActionsEnum.GetVoteData) {
                    return [2, handleGetVoteData(message.payload)];
                }
                _a = message.type;
                switch (_a) {
                    case ActionsEnum.PageReady: return [3, 1];
                    case ActionsEnum.Ping: return [3, 2];
                    case ActionsEnum.GetSettings: return [3, 4];
                    case ActionsEnum.SetSetting: return [3, 5];
                    case ActionsEnum.CanShowAdLeakNotice: return [3, 6];
                    case ActionsEnum.AdLeakEvent: return [3, 7];
                }
                return [3, 8];
            case 1: return [2, handlePageReady(sender)];
            case 2: return [4, chrome.runtime.getPlatformInfo()];
            case 3:
                _b.sent();
                return [2];
            case 4: return [2, handleGetSettings()];
            case 5: return [2, handleSetSetting(message.payload)];
            case 6: return [2, isWatchPageSender(sender) ? canShowAdLeakNotice() : { allowed: false }];
            case 7: return [2, handleAdLeakEvent(message.payload)];
            case 8:
                {
                    console.warn('[listen-messages] unknown message type:', message);
                    return [2];
                }
                _b.label = 9;
            case 9: return [2];
...
var onMessageCallback = function (message, sender, sendResponse) {
    handleMessage(message, sender)
        ...
        console.error('[listen-messages] handler failed:', error);
        var response = {
...
;// ./src/background/helpers/update-action-icon.ts
var update_action_icon_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
var update_action_icon_generator = (undefined && undefined.__generator) || function (thisArg, body) {
    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g = Object.create((typeof Iterator === "function" ? Iterator : Object).prototype);
    return g.next = verb(0), g["throw"] = verb(1), g["return"] = verb(2), typeof Symbol === "function" && (g[Symbol.iterator] = function() { return this; }), g;
    function verb(n) { return function (v) { return step([n, v]); }; }
    function step(op) {
...
var updateActionIcon = function () { return update_action_icon_awaiter(void 0, void 0, void 0, function () {
    var adsEnabled, suffix;
    return update_action_icon_generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                adsEnabled = Settings[SettingsKeys.Ads];
                suffix = adsEnabled ? '' : '-disabled';
                return [4, chrome.action.setIcon({
                        path: {
                            16: "images/icon-16".concat(suffix, ".png"),
                            24: "images/icon-24".concat(suffix, ".png"),
                            32: "images/icon-32".concat(suffix, ".png"),
                        },
                    })];
            case 1:
                _a.sent();
    ...
    return listen_store_changed_generator(this, function (_e) {
        switch (_e.label) {
            ...
            case 2:
                ...
                if (!(key === SettingsKeys.Ads)) return [3, 7];
                Settings[key] = newValue;
                return [4, updateDynamicRules()];
            case 3:
                _e.sent();
                return [4, updateActionIcon()];
            case 4:
                _e.sent();
            ...
            case 5:
                ...
                if (!(url && id && YOUTUBE_REGEX.test(url))) return [3, 7];
...
var runtimeInfoLifeCycle = function () { return runtime_info_awaiter(void 0, void 0, void 0, function () {
    var runtimeInfo;
    var _a, _b;
    return runtime_info_generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 5:
                ...
                return [4, setMultipleToChromeStorage((_b = {},
                        _b[ExtensionsKeys.ExtensionVersion] = runtimeInfo.appVersion,
                        _b[ExtensionsKeys.StorageVersion] = runtimeInfo.schemaVersion,
                        _b[ExtensionsKeys.ShouldCheckUpdatePageConfig] = true,
                        _b[ExtensionsKeys.UpdatePagePending] = false,
                        _b))];
            case 6:
                _c.sent();
                return [4, removeFromChromeStorage(ExtensionsKeys.LastRulesFetchAt)];
            case 7:
                _c.sent();
                _c.label = 8;
            case 8: return [2];
...
var migrateSettingsFromV3toV4 = function () { return migration_awaiter(void 0, void 0, void 0, function () {
    return migration_generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, removeFromChromeStorage(SettingsKeys.OldShowUpdatePageNextLaunch)];
            case 1:
                _a.sent();
                return [2];
        }
...
var migrateSettingsFromV4toV5 = function () { return migration_awaiter(void 0, void 0, void 0, function () {
    return migration_generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, removeFromChromeStorage(SettingsKeys.OldAnnotations)];
            case 1:
                _a.sent();
                return [2];
        }
...
var migrateSettingsFromV5toV6 = function () { return migration_awaiter(void 0, void 0, void 0, function () {
    return migration_generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, setToStorageAndSettings(SettingsKeys.AdLeakNotices, true)];
            case 1:
                _a.sent();
                return [2];
        }
...
var migrationsMap = {
    ...
    '3': migrateSettingsFromV3toV4,
    '4': migrateSettingsFromV4toV5,
    '5': migrateSettingsFromV5toV6,
};
...
var fetchServerData = function (signal) { return server_data_awaiter(void 0, void 0, void 0, function () {
    var response, e_1;
    return server_data_generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4, fetch("".concat("https://api.adblock-for-youtube.com", "/api/v2/rules?version=").concat(EXTENSION_VERSION), { signal: signal })];
            case 1:
                response = _a.sent();
...
var update_settings_from_server_assign = (undefined && undefined.__assign) || function () {
    update_settings_from_server_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return update_settings_from_server_assign.apply(this, arguments);
};
...
var CONFIG_FETCH_ATTEMPTS = 3;
var CONFIG_FETCH_RETRY_DELAY_MS = 1000;
var CONFIG_FETCH_ATTEMPT_TIMEOUT_MS = 5000;
var RULES_FETCH_TTL_MS = 6 * 60 * 60 * 1000;
var update_settings_from_server_wait = function (ms) { return new Promise(function (resolve) { return setTimeout(resolve, ms); }); };
var fetchServerDataWithTimeout = function () { return update_settings_from_server_awaiter(void 0, void 0, void 0, function () {
    var controller, timeout;
    return update_settings_from_server_generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                controller = new AbortController();
                timeout = setTimeout(function () { return controller.abort(); }, CONFIG_FETCH_ATTEMPT_TIMEOUT_MS);
                _a.label = 1;
            case 1:
                _a.trys.push([1, , 3, 4]);
                return [4, fetchServerData(controller.signal)];
            case 2: return [2, _a.sent()];
            case 3:
...
var fetchServerDataWithRetry = function () { return update_settings_from_server_awaiter(void 0, void 0, void 0, function () {
    ...
    return update_settings_from_server_generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                _a.label = 1;
            case 1:
                if (!(attempt <= CONFIG_FETCH_ATTEMPTS)) return [3, 5];
                return [4, fetchServerDataWithTimeout()];
            case 2:
                response = _a.sent();
                if (response) {
                    return [2, response];
                }
                if (!(attempt < CONFIG_FETCH_ATTEMPTS)) return [3, 4];
                return [4, update_settings_from_server_wait(CONFIG_FETCH_RETRY_DELAY_MS * attempt)];
            case 3:
                _a.sent();
                _a.label = 4;
            case 4:
...
var mergeAdLeakNoticeConfig = function (incoming) {
    if (!incoming || typeof incoming !== 'object') {
        return DefaultAdLeakNoticeConfig;
    }
    return update_settings_from_server_assign(update_settings_from_server_assign(update_settings_from_server_assign({}, DefaultAdLeakNoticeConfig), incoming), { detector: update_settings_from_server_assign(update_settings_from_server_assign({}, DefaultAdLeakNoticeConfig.detector), incoming.detector), frequency: update_settings_from_server_assign(update_settings_from_server_assign({}, DefaultAdLeakNoticeConfig.frequency), incoming.frequency), texts: update_settings_from_server_assign(update_settings_from_server_assign({}, DefaultAdLeakNoticeConfig.texts), incoming.texts) });
};
var updateSettingsFromServer = function () { return update_settings_from_server_awaiter(void 0, void 0, void 0, function () {
    var lastRulesFetchAt, msSinceLastFetch, isCacheFresh, response, networkRules, cssRules, scripletsRules, rulesVersion, data;
    var _a;
    return update_settings_from_server_generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                if (!Settings[SettingsKeys.SyncServerRules]) {
                    return [2];
                }
                return [4, getFromChromeStorage(ExtensionsKeys.LastRulesFetchAt)];
            case 1:
                lastRulesFetchAt = _b.sent();
                msSinceLastFetch = lastRulesFetchAt ? Date.now() - lastRulesFetchAt : Infinity;
                isCacheFresh = msSinceLastFetch >= 0 && msSinceLastFetch < RULES_FETCH_TTL_MS;
                if (isCacheFresh) {
                    return [2];
                }
                return [4, fetchServerDataWithRetry()];
            case 2:
                response = _b.sent();
                if (!response || !Array.isArray(response.networkRules)) {
                    return [2];
                }
                networkRules = response.networkRules, cssRules = response.cssRules, scripletsRules = response.scripletsRules, rulesVersion = response.rulesVersion;
                data = (_a = {},
                    _a[SettingsKeys.ScripletsRules] = scripletsRules,
                    _a[SettingsKeys.CssRules] = cssRules,
                    _a[SettingsKeys.NetworkRules] = networkRules,
                    _a[SettingsKeys.RulesVersion] = Number.isInteger(rulesVersion) ? rulesVersion : null,
                    _a);
                return [4, setMultiplyToStorageAndSettings(data)];
            case 3:
                _b.sent();
                return [4, setToChromeStorage(ExtensionsKeys.LastRulesFetchAt, Date.now())];
            case 4:
                _b.sent();
                return [2];
        }
...
var tryOpenUpdatePage = function (updatePageConfig) { return update_settings_from_server_awaiter(void 0, void 0, void 0, function () {
    var shouldCheckUpdatePageConfig, informAboutUpdates, shouldShowForCurrentVersion, e_1;
    var _a;
    return update_settings_from_server_generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 6, , 7]);
                return [4, getFromChromeStorage(ExtensionsKeys.ShouldCheckUpdatePageConfig)];
            case 1:
                shouldCheckUpdatePageConfig = _b.sent();
                if (!shouldCheckUpdatePageConfig) {
                    return [2];
                }
                return [4, getFromChromeStorage(SettingsKeys.InformAboutUpdates)];
            case 2:
                informAboutUpdates = _b.sent();
                if (!(informAboutUpdates === false)) return [3, 4];
                return [4, setMultipleToChromeStorage((_a = {},
                        _a[ExtensionsKeys.ShouldCheckUpdatePageConfig] = false,
                        _a[ExtensionsKeys.UpdatePagePending] = false,
                        _a))];
            case 3:
                _b.sent();
                return [2];
            case 4:
                ...
                return [4, setToChromeStorage(ExtensionsKeys.UpdatePagePending, shouldShowForCurrentVersion)];
            case 5:
                _b.sent();
                return [3, 7];
            case 6:
                e_1 = _b.sent();
                console.error('arm pending update page failed:', e_1);
                return [3, 7];
            case 7: return [2];
        }
    });
}); };
var tryOpenPendingUpdatePage = function () {};
    ...
    return update_settings_from_storage_generator(this, function (_d) {
        switch (_d.label) {
            case 0: return [4, getMultipleFromChromeStorage([
                    ...
                    SettingsKeys.PopupConfig,
                    SettingsKeys.AdLeakNotices,
                    SettingsKeys.AdLeakNoticeConfig,
                    SettingsKeys.RulesVersion,
                    SettingsKeys.DisablePausePopup,
                    SettingsKeys.SyncServerRules,
                    SettingsKeys.LoopControlsEnabled,
                    SettingsKeys.RydEnabled,
                    SettingsKeys.VideoTagsEnabled,
                    SettingsKeys.VolumeBoostEnabled,
                ])];
            case 1:
                result = _d.sent();
                try {
...
(function () { return background_awaiter(void 0, void 0, void 0, function () {
    return background_generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 6:
                _a.sent();
                return [4, tryOpenPendingUpdatePage()];
            case 7:
                _a.sent();
                return [4, updateDynamicRules()];
            case 8:
...
var rydVoteCacheStorageKey = 'rydVoteCache';
var rydVoteCacheTtlMs = (3 * 60 * 60 * 1000);
var handleGetVoteData = function (payload) {
    try {
        var videoId = payload && typeof payload === 'object' && typeof payload.videoId === 'string'
            ? payload.videoId
            : '';
        if (!/^[A-Za-z0-9_-]{11}$/.test(videoId)) {
            return Promise.resolve({ error: 'invalid_video_id' });
        }
        if (Settings[SettingsKeys.RydEnabled] !== true) {
            return Promise.resolve({ disabled: true });
        }
        var likeCount = payload.likeCount !== null && payload.likeCount !== undefined && payload.likeCount !== false
            ? Math.max(0, Math.min(Number(payload.likeCount) || 0, 999999999))
            : null;
        return getFromChromeStorage(rydVoteCacheStorageKey)
            .then(function (cached) {
                var cache = cached && typeof cached === 'object' && !Array.isArray(cached) ? cached : {};
                var hit = cache[videoId];
                if (hit && typeof hit === 'object' && typeof hit.ts === 'number'
                    && Number.isFinite(hit.likes) && Number.isFinite(hit.dislikes)
                    && Date.now() - hit.ts < rydVoteCacheTtlMs) {
                    return { videoId: videoId, likes: hit.likes, dislikes: hit.dislikes, cached: true };
                }
                var url = 'https://returnyoutubedislikeapi.com/votes?videoId=' + encodeURIComponent(videoId);
                if (likeCount !== null) {
                    url += '&likeCount=' + likeCount;
                }
                return fetch(url, { headers: { Accept: 'application/json' } })
                    .then(function (response) {
                        if (!response.ok) {
                            throw new Error('vote_fetch_http_' + response.status);
                        }
                        return response.json();
                    })
                    .then(function (data) {
                        var likes = parseInt(data.likes, 10);
                        var dislikes = parseInt(data.dislikes, 10);
                        if (!Number.isFinite(likes) || !Number.isFinite(dislikes)) {
                            throw new Error('vote_invalid_payload');
                        }
                        cache[videoId] = {
                            ts: Date.now(),
                            likes: likes,
                        ...
                        return setToChromeStorage(rydVoteCacheStorageKey, cache).then(function () {
                            return {
                                videoId: videoId,
                                likes: likes,
                                dislikes: dislikes,
        ...
        return Promise.resolve({ error: 'fetch_failed' });
    }
};
